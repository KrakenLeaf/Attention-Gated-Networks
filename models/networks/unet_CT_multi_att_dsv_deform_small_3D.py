...
class unet_CT_multi_att_dsv_deform_small_3D(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=21, is_deconv=True, in_channels=3,
        ...
        super(unet_CT_multi_att_dsv_deform_small_3D, self).__init__()
        ...
        # downsampling
        self.conv1 = UnetConv3_deformable(self.in_channels, filters[0], self.is_batchnorm, kernel_size=3, padding_size=1)
        self.maxpool1 = nn.MaxPool3d(kernel_size=(2, 2, 2))

        self.conv2 = UnetConv3_deformable(filters[0], filters[1], self.is_batchnorm, kernel_size=3, padding_size=1) # Option 1
        self.maxpool2 = nn.MaxPool3d(kernel_size=(2, 2, 2))

        #self.conv3 = UnetConv3(filters[1], filters[2], self.is_batchnorm, kernel_size=5, padding_size=2, init_dilation=1) # Option 1
        self.conv3 = UnetConv3_deformable(filters[1], filters[2], self.is_batchnorm, kernel_size=3, padding_size=1)  # Option 2 - use this instead of 1
    ...
    def forward(self, inputs_mult):
        ...
        # Feature Extraction
        conv1, _ = self.conv1(inputs)
        maxpool1 = self.maxpool1(conv1)

        conv2, _ = self.conv2(maxpool1)
